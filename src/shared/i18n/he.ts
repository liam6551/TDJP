const he = {
  ...
  aiChat: {
    ...
    welcomeTwist: 'שלום עמיתי. שמי טוויסט, ראש מערך השיפוט הווירטואלי. אני כאן כדי לספק לך ניתוח מדויק ואובייקטיבי על פי חוקת הניקוד. איתי אין הנחות – רק האמת המקצועית.',
