        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.bg }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                    ...
                    <Text style={[styles.text, { color: colors.text }]}>
                        • הקבוצה כוללת מתעמל/ת אחד/ת מכל ענף: טרמפולינה אישית, טרמפולינה מסונכרנת, טאמבלינג, ודאבל-מיני.
                ...
                <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                    <View style={styles.cardHeader}>
                        ...
                        <Text style={[styles.cardTitle, { color: colors.text }]}>3. ביצוע פסים</Text>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <Text style={[styles.text, { color: colors.text }]}>
                            ...
                            {"\n"}• במוקדמות 1 (שני הפסים) אין לחזור על אלמנטים (למעט חריגים בחוק חזרות).
                            ...
                            {"\n"}• הפס חייב לנוע בכיוון אחד בלבד (למעט אלמנט סיום - אלא אם הוא הפוך).
                ...
                <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                    ...
                    <Text style={[styles.text, { color: colors.text }]}>
                        <Text style={{ fontWeight: 'bold' }}>גברים:</Text> בגד גוף ללא שרוולים או שרוול קצר, מכנסיים קצרים, נעליים לבנות/כיסוי לבן.
                        {"\n\n"}
                        <Text style={{ fontWeight: 'bold' }}>נשים:</Text> בגד גוף או אוברול (צמוד לגוף), ניתן ללבוש טייץ ארוך (צמוד ובצבע בגד הגוף). מחשוף בגב עד חצי השכמות.
                        {"\n\n"}
                        <Text style={{ fontWeight: 'bold' }}>כללי:</Text>
                        {"\n"}• שיער אסוף צמוד לראש.
                        {"\n"}• אסור תכשיטים, שעונים או פירסינג. טבעות ללא אבנים מותרות אם הן מכוסות.
                        {"\n"}• לבוש תחתון לא בולט.
                        {"\n"}• חברי קבוצה חייבים ללבוש תלבושת אחידה.
                        {"\n\n"}
                        * חריגות יגררו ענישה של 0.2 נקודות (או פסילה במקרה חמור).
                    </Text>
                </View>
